...
export class UserController{
    private _apiUserService: services.api.ApiUserService

    constructor(apiUserService: services.api.ApiUserService) {
        this._apiUserService = apiUserService
    }


    public  getUsers = async (req: express.Request, res: express.Response): Promise<void> => {
        try {
            const users = await this._apiUserService.getAllUsers()
            res.json(users)
        } catch (err) {
    ...
    public  getUserById = async (req: express.Request, res: express.Response): Promise<void> => {
        const { id } = req.params
        try {
            const user = await this._apiUserService.getUserById(id)
    ...
    public  createUser = async (req: express.Request, res: express.Response): Promise<void> => {
        const newUser = req.body
        try {
            const createdUser = await this._apiUserService.createUser(newUser)
    ...
    public  updateUser = async (req: express.Request, res: express.Response): Promise<void> => {
        const { id } = req.params
        const updatedUser = req.body
        try {
            const user = await this._apiUserService.updateUser(id, updatedUser)
    ...
    public  deleteUser = async (req: express.Request, res: express.Response): Promise<void> => {
        const { id } = req.params
        try {
            const deletedUser = await this._apiUserService.deleteUser(id)
...
const apiUserService = new services.api.ApiUserService()
export const userController = new UserController(apiUserService)
// /**
